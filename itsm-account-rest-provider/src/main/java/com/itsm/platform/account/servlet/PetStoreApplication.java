package com.itsm.platform.account.servlet;
...
public class PetStoreApplication extends Application {
    ...
    public PetStoreApplication() {
        ...
        beanConfig.setFilterClass("com.itsm.platform.account.util.ApiAuthorizationFilterImpl");
        beanConfig.setResourcePackage("com.itsm.platform.account.facade");
